...
<body>
    <main>
        <nav class="bg-blue-800 px-8 py-4 flex items-center justify-between sticky top-0 z-50 shadow-lg">
            ...
            <!-- Logo -->
            <a href="index.php" class="flex items-center gap-2 text-white font-bold text-xl tracking-wide">
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="cart.php"
                    class="flex items-center gap-1.5 text-sm font-medium text-blue-100 hover:text-white hover:bg-blue-700 px-4 py-2 rounded-lg transition duration-200 bg-blue-600">
