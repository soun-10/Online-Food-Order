...
<body class="bg-gray-100 min-h-screen">
  <nav class="bg-blue-800 px-8 py-4 flex items-center justify-between sticky top-0 z-50 shadow-lg">
    ...
    <div class="flex items-center gap-2">
      <a href="home.php"
        class="flex items-center gap-1.5 text-sm font-medium text-white bg-blue-600 bg-blue-500 px-4 py-2 rounded-lg transition duration-200">
      ...
      <?php if (isset($_SESSION['id'])): ?>
        <!-- ✅ Login ហើយ: លាក់ Login button + show Dropdown -->
      ...
      <?php else: ?>
        <!-- ✅ មិនទាន់ Login: show Login + Sign Up -->
