...
<head>
    ...
    <title>Create Account – Online Food Order</title>
        ...
        <div class="icon-wrap">
            <div class="icon-circle">
                <svg width="30" height="30" viewBox="0 0 24 24" fill="currentColor">
                    <path
                        d="M12 12c2.7 0 4.8-2.1 4.8-4.8S14.7 2.4 12 2.4 7.2 4.5 7.2 7.2 9.3 12 12 12zm3.6 1.2H8.4C6 13.2 4.8 14.7 4.8 16.8v1.2h14.4v-1.2c0-2.1-1.2-3.6-3.6-3.6z" />
                    <line x1="19" y1="5" x2="19" y2="11" stroke="currentColor" stroke-width="2.2"
                        stroke-linecap="round" />
                    <line x1="16" y1="8" x2="22" y2="8" stroke="currentColor" stroke-width="2.2"
                        stroke-linecap="round" />
                </svg>
            </div>
        </div>
        ...
        <form id="signupForm" novalidate method="post">
            ...
            <div class="field">
                ...
                <div class="input-wrap" id="wrap-confirm">
                    ...
                    <input type="password" id="confirmPw" name="confirmPw" placeholder="••••••••"
                        autocomplete="new-password" />
