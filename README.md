...
** ជំហានដែលត្រូវធ្វើ
1. ត្រូវ download git (សម្រាប់ Windows 64bits: https://github.com/git-for-windows/git/releases/download/v2.53.0.windows.2/Git-2.53.0.2-64-bit.exe) copy link នេះហើយវានឹង download auto
...
<<<<<<< HEAD
4. បើក Brower ណាមួយ រូចវាយ (http://localhost/Online-Food-Order/) យើងអាចប្រើប្រាស់ App បានហើយ។
=======
4. បើក Brower ណាមួយ រូចវាយ (http://localhost/Online-Food-Order/) យើងអាចប្រើប្រាស់ App បានជាការស្រច។ 
>>>>>>> 783fa2202b17c52af58de71068746b4baabffadc
